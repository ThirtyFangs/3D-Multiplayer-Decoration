...
public class ThreeDMultiplayerDecorationClient implements ClientModInitializer {
	...
	private static final String[] MULTITABLE_COMMAND = {
		"clientgive bat_spawn_egg[entity_data={id:\"minecraft:block_display\",block_state:{Name:\"minecraft:orange_wool\",id:\"minecraft:orange_wool\",Properties:{}},transformation:[-0.6787518456f,0f,0.1292034965f,0.775f,0f,-0.046f,0f,1f,0.1093260355f,0f,0.8021612721f,0.044375f,0f,0f,0f,1f]},item_name={\"color\":\"#FFA64D\",\"text\":\"Table\"},item_model=\"3d_multiplayer_decoration:table\"] 1",
		"clientgive bat_spawn_egg[entity_data={id:\"minecraft:block_display\",block_state:{id:\"minecraft:oak_slab\",Name:\"minecraft:oak_slab\",Properties:{type:\"bottom\"}},transformation:[-0.125f,0f,0f,0.125f,0f,-1.4645f,0f,0.72375f,0f,0f,0.125f,0f,0f,0f,0f,1f]},item_name={\"color\":\"#FFA64D\",\"text\":\"Table\"},item_model=\"3d_multiplayer_decoration:table\"] 1",
		"clientgive bat_spawn_egg[entity_data={id:\"minecraft:block_display\",block_state:{id:\"minecraft:oak_slab\",Name:\"minecraft:oak_slab\",Properties:{type:\"bottom\"}},transformation:[-0.125f,0f,0f,1f,0f,-1.4645f,0f,0.72375f,0f,0f,0.125f,0f,0f,0f,0f,1f]},item_name={\"color\":\"#FFA64D\",\"text\":\"Table\"},item_model=\"3d_multiplayer_decoration:table\"] 1",
		"clientgive bat_spawn_egg[entity_data={id:\"minecraft:block_display\",block_state:{id:\"minecraft:oak_slab\",Name:\"minecraft:oak_slab\",Properties:{type:\"bottom\"}},transformation:[-1f,0f,0f,1f,0f,-0.4815f,0f,0.963125f,0f,0f,1f,0f,0f,0f,0f,1f]},item_name={\"color\":\"#FFA64D\",\"text\":\"Table\"},item_model=\"3d_multiplayer_decoration:table\"] 1",
		"clientgive bat_spawn_egg[entity_data={id:\"minecraft:block_display\",block_state:{id:\"minecraft:oak_slab\",Name:\"minecraft:oak_slab\",Properties:{type:\"bottom\"}},transformation:[-0.125f,0f,0f,1f,0f,-1.4645f,0f,0.72375f,0f,0f,0.125f,0.875f,0f,0f,0f,1f]},item_name={\"color\":\"#FFA64D\",\"text\":\"Table\"},item_model=\"3d_multiplayer_decoration:table\"] 1",
		"clientgive bat_spawn_egg[entity_data={id:\"minecraft:block_display\",block_state:{id:\"minecraft:oak_slab\",Name:\"minecraft:oak_slab\",Properties:{type:\"bottom\"}},transformation:[-0.125f,0f,0f,0.125f,0f,-1.4645f,0f,0.72375f,0f,0f,0.125f,0.875f,0f,0f,0f,1f]},item_name={\"color\":\"#FFA64D\",\"text\":\"Table\"},item_model=\"3d_multiplayer_decoration:table\"] 1"
		...
		ClientCommandRegistrationCallback.EVENT.register((dispatcher, registryAccess) -> dispatcher.register(literal("3dgive_multiplayer")
			.then(literal("table")
				.executes(context -> {
					...
					displayTick = 0;
					context.getSource().sendFeedback(Component.literal("Gave you a table. Make sure to place them in a dispenser. WIP command, clientgive mod required"));
