...
public class ThreeDMultiplayerDecorationClient implements ClientModInitializer {
	...
	private static final String[] MULTITABLE_COMMAND = {
		...
		"clientgive bat_spawn_egg[entity_data={id:\"minecraft:block_display\",block_state:{id:\"minecraft:orange_wool\",Name:\"minecraft:orange_wool\",Properties:{}},transformation:[-0.6787518456f,0f,0.1292034965f,0.775f,0f,-0.046f,0f,1f,0.1093260355f,0f,0.8021612721f,0.044375f,0f,0f,0f,1f]},item_name={\"color\":\"#FFA64D\",\"text\":\"Table\"},item_model=\"3d_multiplayer_decoration:table\"] 1"
	};
